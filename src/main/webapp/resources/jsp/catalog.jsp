        ...
        <div class="container">
            <div class="row">
                <div class="pull-right">
                    <a href="#addHostelModal" type="button" class="btn btn-primary"  data-toggle="modal">+ Add hostel</a>
                </div>
            </div>
        </div>
    </c:if>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row panelBottom">
                                <div class="col-md-6 text-left">
                                    <h5>Price <span class="itemPrice">$${elem.price}</span></h5>
                                </div>
                                <div class="col-md-6 text-right">
                                    <a class="btn btn-success"
                                       href="${pageContext.request.contextPath}/service?command=show_hostel&index=${hostels.indexOf(elem)}">
                                        <span class="fa fa-info" aria-hidden="true"></span> Подробнее
                                    </a>
                                </div>
                            </div>
                        </div>
